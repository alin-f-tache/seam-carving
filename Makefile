...
run_pthread:
	time ./main_pthread img/image-06.pnm img/out.pnm width 500

run_omp:
	time ./main_omp img/image-06.pnm img/out.pnm width 500

run_hibrid:
	time ./main_hibrid img/image06.pnm img/out.pnm width 500
